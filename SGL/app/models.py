...
class Placa96(EmpresaMixin, models.Model):
    ...
    class Meta:
        ...
        verbose_name = 'Placa 96 poços'
        verbose_name_plural = 'Placas 96 poços'
...
class Placa384(EmpresaMixin, models.Model):
    ...
    class Meta:
        unique_together = ['empresa', 'projeto', 'codigo_placa']
        verbose_name = 'Placa 384 poços'
        verbose_name_plural = 'Placas 384 poços'

    def __str__(self):
        return f"{self.projeto.codigo_projeto} - P384 {self.codigo_placa}"
...
class Placa1536(EmpresaMixin, models.Model):
    ...
    class Meta:
        unique_together = ['empresa', 'projeto', 'codigo_placa']
        verbose_name = 'Placa 1536 poços'
        verbose_name_plural = 'Placas 1536 poços'
...
class Poco96(EmpresaMixin, models.Model):
    ...
    class Meta:
        ...
        verbose_name = 'Poço 96'
        verbose_name_plural = 'Poços 96'
...
class Poco384(EmpresaMixin, models.Model):
    ...
    class Meta:
        unique_together = ['placa', 'posicao']
        verbose_name = 'Poço 384'
        verbose_name_plural = 'Poços 384'
...
class Poco1536(EmpresaMixin, models.Model):
    ...
    class Meta:
        unique_together = ['placa', 'posicao']
        verbose_name = 'Poço 1536'
        verbose_name_plural = 'Poços 1536'
